...
<qgis hasScaleBasedVisibilityFlag="1" styleCategories="Symbology|Labeling|Fields|Rendering" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="25001" simplifyLocal="1" version="3.22.11-Białowieża" symbologyReferenceScale="-1" labelsEnabled="0">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" attr="KOD10K" symbollevels="0" referencescale="-1">
    <categories>
      <category render="true" symbol="0" value="0010_338" label="stadion - 0010_338 (19)"/>
      <category render="true" symbol="1" value="0010_341_1" label="skocznia narciarska (w skali) - 0010_341_1 (19)"/>
      <category render="true" symbol="2" value="0010_611" label="basen kąpielowy - 0010_611 (19)"/>
    </categories>
    <symbols>
      ...
      <symbol clip_to_extent="1" type="fill" name="2" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="217,239,250,255"/>
            <Option type="QString" name="joinstyle" value="miter"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MapUnit"/>
            <Option type="QString" name="outline_color" value="105,104,99,255"/>
            <Option type="QString" name="outline_style" value="solid"/>
          ...
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="217,239,250,255"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="105,104,99,255"/>
          <prop k="outline_style" v="solid"/>
    ...
    <source-symbol>
      <symbol clip_to_extent="1" type="fill" name="0" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="66,225,45,255"/>
  ...
  <aliases>
    ...
    <alias name="" index="12" field="nazwa"/>
