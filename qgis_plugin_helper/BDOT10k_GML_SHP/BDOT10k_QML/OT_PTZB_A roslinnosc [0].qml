...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="Symbology|Labeling|Fields|Rendering" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="0" simplifyLocal="1" version="3.22.11-Białowieża" symbologyReferenceScale="-1" labelsEnabled="0">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" attr="KOD10K" symbollevels="0" referencescale="-1">
    <categories>
      <category render="true" symbol="0" value="0010_706" label="zadrzewienie - 0010_706 (0)"/>
      <category render="true" symbol="1" value="0010_723" label="roślinność trawiasta - 0010_723 (0)"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol clip_to_extent="1" type="fill" name="0" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="185,110,189,255"/>
          ...
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="185,110,189,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="charakter" configurationFlags="None"/>
    <field name="roslinnosc" configurationFlags="None"/>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="rodzaj"/>
    <alias name="" index="8" field="charakter"/>
    <alias name="" index="9" field="roslinnosc"/>
    <alias name="" index="10" field="kodKarto10k"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="charakter"/>
    <default expression="" applyOnUpdate="0" field="roslinnosc"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="charakter"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="roslinnosc"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="charakter"/>
    <constraint exp="" desc="" field="roslinnosc"/>
