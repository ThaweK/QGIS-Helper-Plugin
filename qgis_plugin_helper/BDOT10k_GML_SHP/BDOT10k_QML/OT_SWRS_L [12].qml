...
<qgis hasScaleBasedVisibilityFlag="1" styleCategories="Symbology|Labeling|Fields|Rendering" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="25001" simplifyLocal="1" version="3.22.11-Białowieża" symbologyReferenceScale="-1" labelsEnabled="0">
      ...
      <symbol clip_to_extent="1" type="line" name="0" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="7,97,255,255"/>
            <Option type="QString" name="line_style" value="solid"/>
          ...
          <prop k="line_color" v="7,97,255,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <aliases>
    ...
    <alias name="" index="9" field="polozenie"/>
    <alias name="" index="10" field="szerokosc"/>
    <alias name="" index="11" field="szerokosc_uom"/>
    <alias name="" index="12" field="nazwa"/>
    <alias name="" index="13" field="rodzaj"/>
    <alias name="" index="14" field="statusEksploatacji"/>
    <alias name="" index="15" field="przebieg"/>
    <alias name="" index="16" field="identyfikatorMPHP"/>
    <alias name="" index="17" field="informacjaDodatkowa"/>
    <alias name="" index="18" field="cechaGeometrii"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="przebieg"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="przebieg"/>
