...
<qgis hasScaleBasedVisibilityFlag="1" styleCategories="Symbology|Labeling|Fields|Rendering" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="25001" simplifyLocal="1" version="3.22.11-Białowieża" symbologyReferenceScale="-1" labelsEnabled="0">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" attr="KOD10K" symbollevels="1" referencescale="-1">
    <categories>
      <category render="true" symbol="0" value="0010_126" label="droga lokalna gruntowa - 0010_126 (31)"/>
      <category render="true" symbol="1" value="0010_127" label="droga dojazdowa lub wewnętrzna gruntowa - 0010_127 (31)"/>
    </categories>
    <symbols>
