...
<qgis hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" minScale="10001" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" version="3.22.15-Białowieża" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" symbologyReferenceScale="-1" maxScale="0" labelsEnabled="1" simplifyAlgorithm="0">
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory penColor="#000000" showAxis="1" maxScaleDenominator="1e+08" spacingUnitScale="3x:0,0,0,0,0,0" scaleDependency="Area" penWidth="0" barWidth="5" minScaleDenominator="0" direction="0" width="15" diagramOrientation="Up" scaleBasedVisibility="0" spacingUnit="MM" backgroundAlpha="255" lineSizeType="MM" spacing="5" sizeType="MM" lineSizeScale="3x:0,0,0,0,0,0" minimumSize="0" rotationOffset="270" backgroundColor="#ffffff" opacity="1" sizeScale="3x:0,0,0,0,0,0" penAlpha="255" labelPlacementMethod="XHeight" enabled="0" height="15">
  ...
  <DiagramLayerSettings showAll="1" placement="2" linePlacementFlags="18" zIndex="0" priority="0" obstacle="0" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="KATZARZ">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="SZL_NUMER">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="26" field="KOD10K" name=""/>
    <alias index="27" field="KATZARZ" name=""/>
    <alias index="28" field="SZL_NUMER" name=""/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="KATZARZ"/>
    <default expression="" applyOnUpdate="0" field="SZL_NUMER"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="KOD10K" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="KATZARZ" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="SZL_NUMER" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="KATZARZ"/>
    <constraint desc="" exp="" field="SZL_NUMER"/>
  </constraintExpressions>
  <expressionfields>
    <field comment="" expression=" &quot;x_kodKarto10k&quot; " typeName="string" subType="0" type="10" precision="0" name="KOD10K" length="0"/>
    <field comment="" expression=" &quot;katZarzadzania&quot; " typeName="string" subType="0" type="10" precision="0" name="KATZARZ" length="0"/>
    <field comment="" expression="&#xd;&#xa;if(&quot;numer&quot;[1]!='',&quot;numer&quot;[0]+'|'+&quot;numer&quot;[1],&quot;numer&quot;)" typeName="string" subType="0" type="10" precision="0" name="SZL_NUMER" length="0"/>
  </expressionfields>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;gml_id&quot;">
    <columns>
      ...
      <column width="-1" type="field" hidden="1" name="KOD10K"/>
      <column width="-1" type="field" hidden="1" name="KATZARZ"/>
      ...
      <column width="-1" type="field" hidden="1" name="SZL_NUMER"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="KATZARZ" editable="0"/>
    <field name="KOD10K" editable="0"/>
    <field name="SZL_NUMER" editable="0"/>
  ...
  <labelOnTop>
    <field name="KATZARZ" labelOnTop="0"/>
    <field name="KOD10K" labelOnTop="0"/>
    <field name="SZL_NUMER" labelOnTop="0"/>
  ...
  <reuseLastValue>
    <field reuseLastValue="0" name="KATZARZ"/>
    <field reuseLastValue="0" name="KOD10K"/>
    <field reuseLastValue="0" name="SZL_NUMER"/>
